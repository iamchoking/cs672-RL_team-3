...
from raisimGymTorch.env.bin.cs672_pogo_example import NormalSampler
from raisimGymTorch.env.bin.cs672_pogo_example import RaisimGymEnv
...
# changed away from deprecated method dump()
...
# env = VecEnv(RaisimGymEnv(home_path + "/rsc", yaml_output ))
